...
%     meannew = median(mean1,'omitnan');
    bigmeanHYCOM_AE(:,i) = mean1;
end
% HYCOM CEs
mean1 = NaN(21,1);
bigmeanHYCOM_CE = NaN(21,1096);
for i = 1:1096
...
%     meannew = median(mean1,'omitnan');
    bigmeanCMEMS_AE(:,i) = mean1;
end
% HYCOM CEs
mean1 = NaN(21,1);
bigmeanCMEMS_CE = NaN(21,1096);
for i = 1:1096
    CE = Ocolor_eddys_CE(:,i);
    for j = 1:18
        if isempty(Ocolor_eddys_CE(j,i))==0
...
filename_out = '/Volumes/Kate-Research/Data/Eddy_Extraction/EDDY_PROPERTIES/Ocolor_eddies_avg_spatial.mat';
